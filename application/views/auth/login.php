...
<head>
    ...
    <title>TendAsili - A fully automated system</title>
            ...
            <div class="col-md-5 col-md-offset-1">
                <div id="login-alt-container">
                    ...
                    <!-- <h1 class="push-top-bottom">
                        <strong>TendAsili</strong><br>
                        <small>Welcome to TendAsili Admin Dashboard</small>
                    </h1> -->
                    ...
                    <!-- <ul class="fa-ul text-muted">
                        <li><i class="fa fa-check fa-li text-success"></i> Fully Responsive</li>
                        <li><i class="fa fa-check fa-li text-success"></i> User Friendly</li>
                        <li><i class="fa fa-check fa-li text-success"></i> Fully Automated</li>
                    ...
                    <!-- <footer class="text-muted push-top-bottom">
                        <small><?php echo date("Y") ?></span> &copy; <a href="Javascript:void()">TendAsili 2.0</a></small>
                    </footer> -->
                    <!-- END Footer -->
                </div>
            </div>
            <div class="col-md-5">
                ...
                <div id="login-container">
                    ...
                    <div class="login-title text-center">
                        ...
                        <h4><small>Welcome to TendAsili Admin Dashboard</small></h4>
                    </div>
                    <!-- END Login Title -->
                    ...
                    <div class="block push-bit">
                        ...
                        <?php if (validation_errors()) : ?>
                            <?php if (form_error('username')) : ?>
                                <div class="alert alert-danger alert-dismissable">
                                    ...
                                    <h4><i class="fa fa-times-circle"></i> Error </h4><?php echo form_error('username'); ?>
                                </div>
                            <?php endif ?>
                            ...
                            <?php if (form_error('password')) : ?>
                                <div class="alert alert-danger alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                    <h4><i class="fa fa-times-circle"></i> Error </h4><?php echo form_error('password'); ?>
                                </div>
                            <?php endif ?>
                        ...
                        <?php if (!empty($errors)) : ?>
                            <div class="alert alert-danger alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <h4><i class="fa fa-times-circle"></i> Error </h4><?php echo $errors; ?>
                            </div>

                        <?php endif ?>
                        <form action="<?php echo base_url('auth/login') ?>" method="post" id="loginForm" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="gi gi-user"></i></span>
                                        <input type="text" id="username" name="username" class="form-control input-lg" placeholder="Username" value="<?php echo set_value('username'); ?>" lcfirst autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="password" id="password" name="password" class="form-control input-lg" placeholder="Password" lcfirst autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group form-actions">
                                <div class="col-xs-12 text-right">
                                    ...
                                    <!-- <a href="<?php echo base_url('dashboard') ?>" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Login to Dashboard</a> -->
                                </div>
                            </div>
